    ...
    <main className="flex-1 flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-display-italic font-semibold text-[36px] text-ink">Bem-vinda de volta</h1>
        </div>
        ...
        <p className="text-center mt-6 text-[15px] text-ink/70 flex flex-col gap-2">
          <Link href="/esqueci-senha" className="text-orange-dark underline underline-offset-4 font-semibold">
            Esqueci minha senha
          </Link>
          <Link href="/cadastro" className="text-ink/60 underline underline-offset-4">
