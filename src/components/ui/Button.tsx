...
const variantClasses: Record<Variant, string> = {
  primary: "bg-coral text-white hover:bg-coral-dark border border-coral",
  secondary: "bg-transparent text-teal-dark border border-teal hover:bg-teal/10",
  ghost: "bg-transparent text-ink border border-line hover:border-coral",
